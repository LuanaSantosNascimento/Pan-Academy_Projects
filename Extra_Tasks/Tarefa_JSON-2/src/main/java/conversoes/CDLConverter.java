...
public class CDLConverter 
{
	...
	private static void CDLToExampleConversion() 
	{
		...
		//Instancia o JSONObject passando o parâmentro "string" no método construtor
		JSONObject example = new JSONObject(string);	   

		//A varíavel recebe um texto no formato JSON
		String string2 = "{\"0\":\"value2\",\"1\":6,\"2\":-8.345E68,\"3\":false}";	

		//Instancia o JSONObject passando o parâmentro "string2" no método construtor
		JSONObject example2 = new JSONObject(string2);		

		//Instancia um objeto JSONArray
		JSONArray array = new JSONArray();

		//Adiciona o JSONObjetc no array, através do método ".put()"
		array.put(example);						 
		array.put(example2);					

		//Converte os valores do array para formato CDL e armazena na variável output
	...
	private static void CDLFromExampleConversion() 
	{
		...
		//Converte os valores da string para formato JSONArray e armazena na variável output
