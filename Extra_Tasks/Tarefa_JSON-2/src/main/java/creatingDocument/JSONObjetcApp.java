...
public class JSONObjetcApp {
	...
	{
		//Instancia um objeto Map, informando que o primeiro parâmetro deve ser do tipo String e o segundo do tipo Double
		...
		//Instancia um objeto JSONObject passando o parâmentro "map" no método construtor
